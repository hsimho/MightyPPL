...
namespace mightypplcpp {
    ...
    extern std::string build_ta_from_atom(const mightypplcpp::MitlParser::AtomContext*);

    extern std::string build_ta_from_main(mightypplcpp::MitlParser::MainContext*);
