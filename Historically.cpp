...
namespace mightypplcpp {
    ...
    std::pair<std::vector<monitaal::TAwithBDDEdges>, std::string> build_historically(std::stringstream& out_str, monitaal::clock_map_t& clocks, const MitlParser::AtomContext* phi_) {
