...
namespace mightypplcpp {
    ...
    std::pair<monitaal::TA, std::string> build_ta_from_main(MitlParser::MainContext* phi_) {
        ...
        */
        ...
        label = bdd_ithvar(nnf_formula->props.at("p1")) & !bdd_ithvar(nnf_formula->props.at("p2")) & !bdd_ithvar(nnf_formula->props.at("p3")) & !bdd_ithvar(nnf_formula->props.at("p4")) & !bdd_ithvar(nnf_formula->props.at("p5"));
        reset.push_back(1);
