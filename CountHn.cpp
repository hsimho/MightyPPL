            ...
            *****/
            ...
            if (out_format.has_value()) {
                ...
                if (out_format.value()) {
                    ...
                    out_str << "location:" << "TA_" << phi->id << ":ell_0{labels: accept_" << phi->id << "_" << phi->num_pairs << "}" << std::endl;
                    out_str << "location:" << "TA_" << phi->id << ":ell_1{labels: accept_" << phi->id << "_" << phi->num_pairs << "}" << std::endl;
                    out_str << "location:" << "TA_" << phi->id << ":ell_2{labels: accept_" << phi->id << "_" << phi->num_pairs << "}" << std::endl;
